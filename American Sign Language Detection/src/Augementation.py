...
class CustomDataset():
    def __init__(self, input_folder):
        ...
        self.classes = [item for item in self.classes if item != 'asl_dataset']
...
def balance_dataset(min_threshold, max_threshold, output_folder, input_folder,plot_file):
    ...
    if(max_threshold<min_threshold):
        raise "max_threshold cannot be less than min_threshold"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--min_threshold", type=int, default=None, help="Minimum  numebr of samples")
